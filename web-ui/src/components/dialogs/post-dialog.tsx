...
export const PostDialog = () => {
    ...
    const { setPosts, setIsDialogVisible, isDialogVisible, setCurrentPostId, currentPostId, setIsToastVisible } =
        useAppSharedContext();
    ...
    const onConfirmPostClickHandler = useCallback(async () => {
        onCloseClickHandler();
        ...
        if (post.message.trim() && post.topic.trim()) {
            ...
            if (uploadedFile) {
                createdOrUpdatedPost.uploadedFiles = createdOrUpdatedPost.uploadedFiles
                    ? createdOrUpdatedPost.uploadedFiles
                    : [];
    ...
    return (
        <Dialog open={isDialogVisible} onClose={onCloseClickHandler}>
            <Typography className="flex items-center h-12 p-7 font-bold" variant="h5">
                Add your own post
            </Typography>
            <DialogContent className="pb-4 space-y-4">
                <TextField
                    label="Topic"
                    variant="outlined"
                    value={post.topic}
                ...
                <div className={'flex flex-col gap-2'}>
                    <form id="file-upload-form" encType="multipart/form-data">
                        ...
                        <label htmlFor="file-upload">
                            <Button sx={{ color: 'primary.main' }} variant="outlined" component="span">
                                Choose File
                            </Button>
                        </label>
                    </form>
            ...
            <DialogActions>
                ...
                <Button variant="contained" color="success" onClick={onConfirmPostClickHandler}>
                    Confirm
                </Button>
            </DialogActions>
        </Dialog>
