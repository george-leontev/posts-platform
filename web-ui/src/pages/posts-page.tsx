...
import { Box, Button, Snackbar, Tooltip, createTheme, ThemeProvider } from '@mui/material';
        ...
        <ThemeProvider theme={isDarkMode ? darkTheme : lightTheme}>
            <motion.div className="flex flex-col h-full">
                ...
                >
                    ...
                    <div
                        className={`transition-all duration-500 ${isDrawerOpen && !isSmallScreen ? 'pl-[280px]' : 'pl-0'}`}
                    >
